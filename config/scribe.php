...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Retrieve a token by sending your credentials to <code>POST /api/v1/auth/login</code>, then send it as a <code>Bearer</code> token in the <code>Authorization</code> header.',
    ],
